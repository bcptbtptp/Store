...
<form class="form-horizontal" action="user?method=login" method ="post">
 ...
 <div class="form-group">
    ...
    <div class="col-sm-6">
      <input type="text" class="form-control" id="username" name="username" <c:if test="${not empty cookie.remberUsername}"> value="${cookie.username.value}"</c:if> placeholder="请输入用户名"><span>${errorMsg}</span>
    </div>
  </div>
   <div class="form-group">
   ...
   <div class="form-group">
    ...
    <div class="col-sm-3">
      <input type="text" class="form-control" id="inputPassword3" name="yzCode" placeholder="请输入验证码">
    </div>
    <div class="col-sm-3">
   ...
   <div class="form-group">
    <div class="col-sm-offset-2 col-sm-10">
      <div class="checkbox">
        ...
        <label>
          <input type="checkbox" name="remberUsername"> 记住用户名
        </label>
      </div>
    </div>
  </div>
