		...
		<div class="container-fluid">
			...
			<div class="container-fluid">
				...
				<div class="col-md-10">
					<div class="col-md-6" style="text-align:center;height:200px;padding:0px;">
						<a href="product?method=details&pid=${pHotList.get(0).pid}">
							<img src="${pHotList.get(0).pimage}" width="516px" height="200px" style="display: inline-block;">
						</a>
					</div>
				<c:forEach var="p" items="${pHotList }" begin="1">
			...
			<div class="container-fluid">
				...
				<div class="col-md-10">
					<div class="col-md-6" style="text-align:center;height:200px;padding:0px;">
						<a href="product?method=details&pid=${pHotList.get(0).pid}">
							<img src="${pNewList.get(0).pimage}" width="516px" height="200px" style="display: inline-block;">
						</a>
					</div>
				<c:forEach var="p" items="${pNewList }" begin="1">
					<div class="col-md-2" style="text-align:center;height:200px;padding:10px 0px;">
						<a href="product?method=details&pid=${p.pid}">
							<img src="${p.pimage }" width="130" height="130" style="display: inline-block;">
						</a>
